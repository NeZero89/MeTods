...
public class Main {
    ...
    public static void clientOsYear(int clientDiviceYear,int clientOS) {
    ...
    public static int diliveryDistanceCl (int diliveryDistsnce){
    ...
    public static void task2() { System.out.println("Задача №2");
        ...
        int clientOS = 1;
        clientOsYear(currentYear,clientOS);
    }
